...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="L:/Deeplearning/e2ec-main_ACM/Mydataset/val2017"
    )
    parser.add_argument(
        "--output", help="Output json file path.", default="L:/Deeplearning/e2ec-main_ACM/Mydataset/annotations/val.json"
    )
